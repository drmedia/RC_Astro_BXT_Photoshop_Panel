...
<p align="center">
  <img src="docs/images/panel-main-v0.9.1.png" width="420" alt="BlurXTerminator 패널 기본 화면">
</p>

<p align="center"><em>현재 Photoshop 상태에 따라 처리 대상과 결과 마스크를 자동으로 판정합니다.</em></p>

<details>
<summary><strong>세부 설정·환경 설정·사용 설명서 보기</strong></summary>
...
<table>
  ...
  <tr>
    <td><img src="docs/images/panel-details-v0.9.1.png" width="360" alt="BlurXTerminator 세부 설정 화면"></td>
    <td><img src="docs/images/panel-settings-v0.9.1.png" width="360" alt="RC-Astro 실행 파일 및 임시 TIFF 설정 화면"></td>
  </tr>
  <tr>
    <th>패널 내 사용 설명서</th>
    <th>처리 결과 레이어</th>
  ...
  <tr>
    <td><img src="docs/images/panel-help-v0.9.1.png" width="360" alt="패널 내 사용 설명서 화면"></td>
    <td><img src="docs/images/result-layer-v0.9.1.png" width="360" alt="Photoshop에 추가된 BlurXTerminator 결과 레이어"></td>
  </tr>
</table>
...
설치 프로그램은 Windows 표시 언어를 자동 감지하며, 시작할 때 한국어 또는
English를 직접 선택할 수도 있습니다. 명령줄에서 선택 화면 없이 실행하려면
`Install_Windows.bat --lang=ko` 또는 `Install_Windows.bat --lang=en`을 사용하세요.
`Uninstall_Windows.bat`도 같은 언어 선택 방식을 지원합니다.
...
2. 우측 상단 설정에서 언어, RC-Astro CLI와 라이선스 상태를 확인합니다.
